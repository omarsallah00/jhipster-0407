package ma.directinfo.backend.web.rest;

import ma.directinfo.backend.DirectinfoApp;
import ma.directinfo.backend.domain.Authority;
import ma.directinfo.backend.domain.User;
import ma.directinfo.backend.repository.AuthorityRepository;
import ma.directinfo.backend.repository.PersistentTokenRepository;
import ma.directinfo.backend.repository.UserRepository;
import ma.directinfo.backend.security.AuthoritiesConstants;
import ma.directinfo.backend.service.MailService;
import ma.directinfo.backend.service.UserService;
import ma.directinfo.backend.service.dto.UserDTO;
import ma.directinfo.backend.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = DirectinfoApp.class)

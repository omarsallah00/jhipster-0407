...
import ma.directinfo.backend.domain.PersistentToken;
...
import ma.directinfo.backend.security.SecurityUtils;
...
import ma.directinfo.backend.web.rest.vm.KeyAndPasswordVM;
import ma.directinfo.backend.web.rest.vm.ManagedUserVM;
import ma.directinfo.backend.web.rest.util.HeaderUtil;
